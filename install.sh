...
echo "==========================================================="
echo "  mcp-state Installer (Linux / macOS)"
echo "==========================================================="
  ...
  darwin)
    case "${ARCH}" in
      ...
      *)
        ...
        echo "[-] To install on ${ARCH}, build with cargo: cargo install --git https://github.com/JohnnytheShark/mcp-state mcp-state" >&2
        exit 1
        ;;
    esac
    ;;
...
mv "${TMP_DIR}/${ARCHIVE_NAME}/mcp-state" "${INSTALL_DIR}/mcp-state"
chmod +x "${INSTALL_DIR}/mcp-state"

echo ""
echo "==========================================================="
echo "  ✓ Successfully installed mcp-state to ${INSTALL_DIR}/mcp-state"
echo "==========================================================="
echo ""
...
echo "Run 'mcp-state' to get started!"
